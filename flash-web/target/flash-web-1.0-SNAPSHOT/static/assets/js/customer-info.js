...
function addTable(pageInfo){
    ...
    $.each(pageInfo.list, function(index, obj){
        $('#tab').append(
            ...
            '<td>'+obj.cId+'</td>'+
            '<td>'+obj.name+'</td>'+
            '<td class="font-weight-600">'+obj.phone+'</td>'+
            '<td class="font-weight-600">'+obj.address+'</td>'+
            '<td>'+obj.reAddress1+'</td>'+
            '<td>'+obj.reAddress2+'</td>'+
            '<td>'+obj.reAddress3+'</td>'+
            '<td><a href="#" class="btn btn-primary">详情</a></td>'+
            '</tr>'
        );
    });
}
